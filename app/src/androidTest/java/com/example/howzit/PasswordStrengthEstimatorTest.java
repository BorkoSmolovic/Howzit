...
public class PasswordStrengthEstimatorTest {

    PasswordStrengthEstimator SUT; // System under test (SUT)
    EditText editText;

    @Before
    public void setup(){
        SUT = new PasswordStrengthEstimator();
    }

    //TODO: find a way to test private functions with Junits
}