...
/**
 * Class used to represent a plain text message. This is the main way to handle messages inside the application.
 * The messages are then encapsulated into the {@link EncryptedMessage} when they are sent or received.
...
public class TextMessage extends Message{
    ...
    /**
     * ID of the receiver, for redundancy
     */
    private final int receiverID;

    /**
     * ID of the sender, to choose the right key for signature decryption
     */
    ...
    /**
     * hash of the text, then encrypted with sender private key
     */
    ...
    public TextMessage(int receiverID, int senderID, String text, String n, String ts, byte[] sgn){
