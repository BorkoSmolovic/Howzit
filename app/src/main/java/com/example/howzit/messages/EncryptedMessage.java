...
/**
 * Class used to contain an encrypted message
 */
public class EncryptedMessage implements Serializable {
    /**
     * Actual payload, encrypted
     */
    ...
    /**
     * Constructor.
     * @param d the encrypted data
     */
    public EncryptedMessage(byte[] d, byte[] k){
        this.data = d;
        this.aesKey = k;
    }
    ...
    public byte[] getAesKey() {return this.aesKey;}
