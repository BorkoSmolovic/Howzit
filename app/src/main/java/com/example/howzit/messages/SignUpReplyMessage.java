...
/**
 * This class is used to represent the response, sent from the server to the client,
 * after a sign up message. It contains a new ID the client can now use.
...
public class SignUpReplyMessage extends Message {
    ...
    /**
     * Constructor.
     * @param newID the new generated ID.
     */
    ...
    /**
     * Getter.
     * @return the new generated ID contained in the message.
     */
