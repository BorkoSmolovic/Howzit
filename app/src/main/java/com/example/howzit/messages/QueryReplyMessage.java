...
/**
 * This class represent a reply to a query, sent from the server to the requesting client.
...
public class QueryReplyMessage extends Message {
    ...
    /**
     * ID of the user whom IP has been requested
     */
    private final int requestedID;

    /**
     * IP of the requested user
     */
    ...
    /**
     * Constructor.
     * @param requestedID ID of the user whom IP has been requested
     * @param requestedIP IP of the requested user
     */
    ...
    /**
     * Getter.
     * @return the ID of the user whom IP has been requested
     */
    public int getRequestedID() {return this.requestedID;}

    /**
     * Getter.
     * @return the IP of the requested user
     */
