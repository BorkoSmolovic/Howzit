...
/**
 * Class used to represent a publish message. This message will notify the server about a new location of a user.
...
public class PublishMessage extends Message {
    ...
    /**
     * ID of the sender, to locate it in the Server DB
     */
    private final int senderID;

    /**
     * IP of the sender, to be updated in the Server DB
     */
