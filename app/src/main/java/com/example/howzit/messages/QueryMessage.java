...
/**
 * Class to represent a query message to the server.
...
public class QueryMessage extends Message {
    ...
    /**
     * ID of the user whom we want the IP
     */
    ...
    /**
     * Constructor
     * @param requestedID the ID of the user we want the IP of.
     */
    ...
    /**
     * Getter.
     * @return the ID of the user we want the IP of.
     */
